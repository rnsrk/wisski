...
namespace Drupal\wisski_adapter_sparql11_pb\Entity;

use Drupal\wisski_salz\Entity\Adapter as AdapterBase;
 ...
 * 
 * @ConfigEntityType(
 *   id = "wisski_salz_pb_adapter",
 *   label = @Translation("WissKI Salz Adapter with Path Builder"),
 *   handlers = {
 ...
 *     },
 *   },
 *   config_prefix = "wisski_salz_pb_adapter",
 ...
 * )
 */
class Adapter extends AdapterBase implements AdapterInterface {
  /**
