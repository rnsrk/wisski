    ...
    if ($settings['use_readmore']) {
      ...
      if (!empty($elements)) {
        ...
        if (!empty($elements['#attributes']) && !empty($elements['#attributes']['class'])) {
          $elements['#attributes']['class'] = array_merge($elements['#attributes']['class'], ["field-readmore " . $unique_id]);
        }
        else {
          $elements['#attributes']['class'] = ["field-readmore " . $unique_id];
        }
