...
abstract class Sparql11Engine extends EngineBase {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['endpoint']['is_federatable'] = [
      ...
      '#return_value' => TRUE,
      '#description' => $this->t('Marks this adapter as <em>federatable</em> and the endpoint URLs reachable from other adapters. '),
    ];
    ...
    $form['properties']['same_as_properties']['available_same_as_properties'] = array(
      '#type' => 'select',
