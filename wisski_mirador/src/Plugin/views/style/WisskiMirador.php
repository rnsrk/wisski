...
class WisskiMirador extends StylePluginBase {
  ...
  protected function defineOptions() {
    ...
    $options['path'] = ['default' => 'wisski_mirador'];
    return $options;
  }
  ...
  public function render() {
    ...
    foreach ($results as $result) {
      $ent_list[] = ["manifestUri" => $base_url . "/wisski/navigate/" . $result->eid . "/iiif_manifest", "location" => $to_print];
    }
    ...
    $form['#allowed_tags'] = ['div', 'select', 'option', 'a', 'script'];
