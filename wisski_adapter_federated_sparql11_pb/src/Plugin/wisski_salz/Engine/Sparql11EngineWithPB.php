...
namespace Drupal\wisski_adapter_federated_sparql11_pb\Plugin\wisski_salz\Engine;
...
use Drupal\wisski_adapter_federated_sparql11_pb\Query\Query;
use \EasyRdf;
 ...
 *
 * @Engine(
 *   id = "federated_sparql11_with_pb",
 *   name = @Translation("Federated Sparql 1.1 With Pathbuilder"),
 *   description = @Translation("Provides access to a federated SPARQL 1.1 endpoint and is configurable via a Pathbuilder")
 * )
 */
