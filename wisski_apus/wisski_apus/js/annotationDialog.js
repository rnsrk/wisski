 ...
 * Open the annotation dialog and show the given annotation
    */
        dialog.showAnnotation = function (anno) {
            ...
            dialog.annoDialog.$element.find('.target-list .pick-entity-button').on(
                'click', function (e) {
                    var $button = $(e.target);
            ...
            dialog.annoDialog.$element.find('.add-entity-button').on(
                'click', function (e) {
            ...
            dialog.annoDialog.$element.find('.suppress-link').on(
                'click', function (e) {
                    // deactivate the link
                    e.preventDefault();
                    //        return false;
 ...
 * Change the value of the search term input field.
    ...
    */
        ...
        $dialog.find('.wisski-search-field input').on(
            'keyup change', Drupal.debounce(
                function (evt) {
