...
class EditForm extends FormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    drupal_set_message($this->t('Saved %label configuration.', ['%label' => $this->processor->getLabel()]));
    $this->logger('wisski_pipe')->notice(
        'The processor %label has been updated in the @pipe pipe.', [
