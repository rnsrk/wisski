...
class WisskiFieldDeleteForm extends EntityConfirmFormBase {
  ...
  public function getQuestion() {
    ...
    return $this->t('Do you want to delete the field @id associated with this path?', ['@id' => $this->field_id]);
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if ($this->field_type == "field" || $this->field_type == "both") {
      ...
      drupal_set_message($this->t('The field with id @id has been deleted.', ['@id' => $this->field_id]));
    }

    if ($this->field_type == "bundle" || $this->field_type == "both") {
      // Bundle mode.
      $bundle_storages = \Drupal::entityManager()->getStorage('wisski_bundle')->loadByProperties(['id' => $this->field_id]);
      ...
      drupal_set_message($this->t('The Bundle with id @id has been deleted.', ['@id' => $this->field_id]));
    }
