...
class WisskiBundleForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    elseif ($this->operation == 'edit') {
      $form['#title'] = $this->t('Edit %label bundle', ['%label' => $bundle->label()]);
    }
    ...
    $form['id'] = [
      ...
      '#disabled' => FALSE,
      '#machine_name' => [
        'exists' => ['\Drupal\wisski_core\Entity\WisskiBundle', 'exists'],
        'source' => ['label'],
      ],
...
*/
    ...
    foreach ($bundle->enable_menu_items as $mid => $v) {
      if ($v) {
        $menu_items[$mid] |= WisskiBundle::MENU_ENABLE;
      }
    }
