...
class WisskiTitlePatternDeleteForm extends EntityConfirmFormBase {
  ...
  public function getQuestion() {
    $bundle = $this->entity;
    return $this->t('Do you really want to delete the title pattern for %label (bundle %bundle)?', ['%label' => $bundle->label(), '%bundle' => $bundle->id()]);
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $bundle->save();
    drupal_set_message(t('Removed title pattern for bundle %name.', ['%name' => $bundle->label()]));
