  ...
  public function render(ResultRow $values) {
    ...
    if (is_array($value)) {
      ...
      if (!empty($this->options['display_as_link']) && !empty($eid)) {
        // "<a href='" . Url::fromRoute('entity.wisski_individual.canonical', ['wisski_individual' => $entity]) . "'>" . $this->sanitizeValue($value) . "</a>";.
        return \Drupal::l($this->sanitizeValue($value), Url::fromRoute('entity.wisski_individual.canonical', ['wisski_individual' => $eid]));
      }
      else {
