...
class WisskiBundleListBuilder extends ConfigEntityListBuilder implements EntityHandlerInterface {
  ...
  public function buildRow(EntityInterface $entity) {
    ...
    switch ($this->type) {
      case self::NAVIGATE:
        return $this->buildMenuNavigateRow($entity, $menus['navigate']);

      // $this->buildNavigateRow($entity, $menus['navigate']);.
      case self::CREATE:
  ...
  public function render($type = self::CONFIG) {
    ...
    $build = parent::render();
    $build['#empty'] = t(
        'No WissKI bundle available. <a href="@link">Add media bundle</a>.', [
